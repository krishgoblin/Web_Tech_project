        ...
        <div class="shop-section">
            <div class="box">
                <div class="box-content">
                    <h2>Ear Ring 1</h2>
                    <div class="box-img" style="background-image: url('./../jewelleryAssets/Card2.webp')"></div>
                    <p>Price: &#8377 40</p>
            ...
            <div class="box">
                <div class="box-content">
                    <h2>Ear Ring 2</h2>
                    <div class="box-img" style="background-image: url('./../jewelleryAssets/card5.jpg')"></div>
                    <p>Price: &#8377 60</p>
                    <button>Add to Cart</button>
                </div>
            </div>
            <div class="box">
                <div class="box-content">
                    <h2>Ear Ring 3</h2>
                    <div class="box-img" style="background-image: url('./../jewelleryAssets/Card6.webp')"></div>
                    <p>Price: &#8377 10</p>
                    <button>Add to Cart</button>
                </div>
            </div>
            <div class="box">
                <div class="box-content">
                    <h2>Ear Ring 4</h2>
                    <div class="box-img" style="background-image: url('./../jewelleryAssets/Card7.webp')"></div>
                    <p>Price: &#8377 1000</p>
                    <button>Add to Cart</button>
                </div>
            </div>
